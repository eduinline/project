...
/**
 * <p>室外展示温度数据，实现Observer接口</p>
 * 
 * @version 1.0 2016年7月8日-下午3:51:53
 * @author hongze.he@eduinline.com
 */
public class OutSideDisplay implements Observer {
	 ...
	 */
	public OutSideDisplay(Observable observable){
	...
	public void update(Observable o, Object arg) {
		...
		System.out.println("处理在室外展示数据："+data.toString());
	}
