...
public class DatagramSocketUnicast extends DatagramSocketAbs{
	...
	/**
	  ...
	  */
	public DatagramSocketUnicast(String toHost, int toPort){
		this.toHost = toHost;
		this.toPort = toPort;
	}
	...
	/**
	  ...
	  */
	public DatagramSocketUnicast(String toHost, int toPort, String localHost, int localPort){
		this.toHost = toHost;
		this.toPort = toPort;
	...
	/**
	 * 使用初始化时设置的目标地址<B>单播</B>发送数据报
	 * @param msg 需要发送的数据
	 * @throws IOException
	 */
	public void sendUnicast(byte[] msg) throws IOException{
	...
	/**
	 * 根据参数设置的目标地址<B>单播</B>发送数据报
	 * @param msg 需要发送的数据
	 * @param toHost 目标地址
	 * @param toPort 目标端口
	 * @throws IOException
	 */
	public void sendUnicast(byte[] msg, String toHost, int toPort) throws IOException{
